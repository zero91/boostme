...
class ebankmodel {
    ...
    public function alipayreturn() {
        ...
        $result = array();
        runlog("test007", "alipayreturn_model[" . var_export($_GET, true) . "]");
        ...
        runlog("test007", "alipayreturn_model.result[" . var_export($result, true) . "]");
        return $result;
    }
    ...
    public function alipaynotify() {
        ...
        runlog("test007", "alipaynotify_model[" . var_export($_POST, true) . "]");
        $result = array();
        if ($verify_result) {//验证成功
            $result['succeed'] = true;
        ...
        runlog("test007", "alipaynotify_model.result[" . var_export($result, true) . "]");
        return $result;
    }
    ...
    public function alipay_send_goods($transaction_id, $logistics_name, $invoice_no, $transport_type) {
