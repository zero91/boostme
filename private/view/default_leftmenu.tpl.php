...
<div class="sidebar">
  <div class="panel" style="position:relative;">
    ...
    <div class="userinfo" style="font-size:13px;height:80px;"><h5><?=$user['username']?></h5></div>
  </div>

  <ul class="list-unstyled" style="font-size:13px;">
    <li><h5>个人空间</h5></li>
    <ul class="nav nav-sidebar">
      <li id="menu_space" <? if($type == "user/space") { ?> class="active"<? } ?> > <a href="<?=SITE_URL?>?user/space.html">最近动态</a> </li> 
    </ul>
