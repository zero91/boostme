...
class UcenterUserModel extends Model {
    ...
    public function login($username, $password, $type = 1) {
        ...
        if (is_array($user) && $user['status']) {
            if (bm_ucenter_md5($password, UC_AUTH_KEY) === $user['password']) {
